...
export const CTASection = ({ onShowRegister, onStartFunnel }: CTASectionProps) => {
  return (
    <section className="py-16 px-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-center text-white">
      <div className="container mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button size="lg" variant="secondary" onClick={onStartFunnel} className="bg-white text-blue-600 hover:bg-gray-100">
            Start Your Request
          </Button>
